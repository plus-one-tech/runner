...
| AT     | 概要                 | 判定 | 該当テスト                                                                 | 備考         |
| ------ | ------------------ | -: | --------------------------------------------------------------------- | ---------- |
| AT-010 | ファイル指定実行           |  △ | `TestTargetOptionAfterIsRejected`, `TestExtensionNotMapped`, P01, P03 | 前提として通っている |
| AT-011 | `.run` 明示指定実行      |  △ | `TestDryRunDoesNotExecute`, `TestCheckScriptAllOS`, P01, P02, P03     | 前提として通っている |
